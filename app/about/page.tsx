  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 pb-16">
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <Reveal delayMs={200}>
          <div className="mt-10 rounded-2xl border border-slate-200 bg-[#F1F7FF] p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(15,31,61,0.12)] hover:border-[#0F1F3D]">
        ...
        <Reveal delayMs={260}>
          <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(15,31,61,0.12)] hover:border-[#0F1F3D]">
        ...
        <Reveal delayMs={320}>
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(15,31,61,0.12)] hover:border-[#0F1F3D]">
