    ...
    <main>
      ...
      <section className="bg-[#F9FAFB] px-4 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-[#E5E7EB] bg-white p-6 shadow-sm premium-card-hover">
      ...
      <section className="bg-white px-4 py-16">
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[#E5E7EB] bg-white p-8 shadow-sm premium-card-hover">
